...
@section('PageContent')
    ...
    @if (auth()->user()->can('Branche_create-switch-model'))
                        ...
                        <table class="table project-list-table table-nowrap align-middle table-borderless">
                            ...
                            <tbody>
                                @foreach ($lists as $list)
                                    <tr>
                                        <td>
                                            <a _href="{{ route('switch-model.edit', $list->id) }}">
                                                {{ $list->name ?? '' }}
                                            </a>
                                        </td>
